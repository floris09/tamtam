  ...
  return (
    <div className='instagram-component'>
      <div className='instagram-container'>
        ...
        { this.props.instagram.map((insta, index) => <div className='instagram-item' > <a href='https://instagram.com/tamtamnl' target='_blank' rel='noopener noreferrer'> <div className='instagram-pic' style={{backgroundImage:'url(' + insta.thumbnail_url + ')'}} alt='instagram' key={index} /> </a> <p>{ insta.title }</p> </div> ) }
      </div>
    </div>
  )
}
